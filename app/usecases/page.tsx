            ...
            <div className="mx-auto max-w-4xl">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
                <div className="flex-1">
                  ...
                  {/* Matrix visualization - subtle animation */}
                ...
                <ScrollAnimation key={useCase.id} delay={index * 50}>
                  <Card className="border rounded-xl overflow-hidden flex flex-col h-full transition-opacity hover:opacity-90">
                    ...
                    <CardHeader className="pb-4">
                      <CardTitle className="text-xl font-light mb-3">
                        {useCase.title}
                      </CardTitle>
                    ...
                    <CardContent className="flex-1 pb-4">
                      <div className="space-y-4">
                        <div>
                          <h3 className="text-xs font-normal mb-2 text-muted-foreground uppercase tracking-wider">
                            Features
                          </h3>
                          <div className="flex flex-wrap gap-2">
                            {useCase.features.slice(0, 3).map((feature, idx) => (
                              <span
                                key={idx}
                                className="text-xs px-2 py-1 rounded-md border bg-muted/50 text-muted-foreground"
                              >
                          ...
                          <ul className="space-y-1.5">
                            {useCase.benefits.slice(0, 2).map((benefit, idx) => (
                              <li key={idx} className="text-xs text-muted-foreground flex items-start">
                                <span className="mr-1.5 text-foreground mt-0.5">•</span>
                                <span>{benefit}</span>
                              </li>
                            ))}
                          </ul>
                    ...
                    <div className="px-6 pb-6 pt-0">
                      <div className="flex gap-3">
                        ...
                        <Link href="/contact">
                          <Button variant="outline" className="font-normal text-xs flex-1" size="sm">
                            Book a Call
                          </Button>
                        </Link>
                      </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-0 md:items-stretch">
                  ...
                  <div className="flex flex-col p-8 md:p-12">
                    <CardHeader className="p-0 pb-6">
                      ...
                      <CardTitle className="text-2xl font-light mb-4 md:text-3xl">
                        MILO
                      </CardTitle>
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <ul className="space-y-2">
                            ...
                            <li className="text-sm text-muted-foreground flex items-start">
                              <span className="mr-2 text-foreground">•</span>
                              Voice-activated content navigation and search
                            </li>
                            <li className="text-sm text-muted-foreground flex items-start">
                              <span className="mr-2 text-foreground">•</span>
                            ...
                            <li className="text-sm text-muted-foreground flex items-start">
                              <span className="mr-2 text-foreground">•</span>
                              Real-time speech-to-text for note-taking
                            </li>
                          </ul>
                        </div>
                        <Separator />
                    ...
                    <div className="flex gap-4 pt-6">
                      <a 
                        href="https://www.google.com/search?q=MILO+TF1&sca_esv=e373368215e95de4&rlz=1C5CHFA_enFR1101FR1102&sxsrf=ANbL-n58ICkh8Hfv984pNWz-oeJKxffeBw%3A1768222118772&ei=pu1kaeXwLsHX7M8Pnt2a0Qg&ved=0ahUKEwjl25fahIaSAxXBK_sDHZ6uJooQ4dUDCBE&uact=5&oq=MILO+TF1&gs_lp=&sclient=gws-wiz-serp"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                        <Button className="font-normal flex-1 md:flex-initial">
                          Learn More
                        </Button>
                      </a>
                      <Link href="/contact">
                        <Button variant="outline" className="font-normal flex-1 md:flex-initial">
                          Book a Call
                        </Button>
                      </Link>
                    </div>
